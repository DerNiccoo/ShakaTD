...
namespace ShakaTD.Manager
{
    ...
    class Content_Manager
    {
        ...
        public void LoadTextures(ContentManager Content)
        {
            ...
            AddTexture("Grafiken/Tower/gun3", "gun3");
            AddTexture("Grafiken/Tower/gunfire1", "gunfire1");
            AddTexture("Grafiken/Tower/missle1", "missile1");
            AddTexture("Grafiken/Tower/missle2", "missile2");
            ...
            AddTexture("Grafiken/Tower/rocketPlatt", "rocketPlatt");
